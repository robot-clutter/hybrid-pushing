...
def analyze_train_and_eval(exp_name, smooth):
    exps = {
        dir: {'path': '../logs/eval_' + exp_name}
    }
    # analyze_eval_results(exps)

    analyze_train_results('../logs/train_' + exp_name, smooth)


# if __name__ == '__main__':
#     # dir = 'eval_analytic_without_randomize'
#     # dir = 'analytic_20_40'
#     # dir = 'analytic_me_diorthwsi'
#     # dir = 'ral_push_target_real_real_v2'
#     dir = 'high_level'
#
#     exps = {
#         dir: {'path': '../logs/eval_' + dir}
#     }
#     analyze_eval_results(exps)
#
#     analyze_train_results('../logs/train_' + dir)
